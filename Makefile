...
meujogo: main.o menu.o jogo.o som.o config.o fisica.o inimigo.o
		# Compilando o jogo
		gcc -o meujogo som.o jogo.o menu.o config.o main.o fisica.o inimigo.o -lm -lSDL2 -lSDL2_image -lSDL2_mixer -lSDL2_ttf 2>log/meujogo.gccmessages
...
#
main.o: main.c main.h menu.h jogo.h config.h fisica.h inimigo.h
