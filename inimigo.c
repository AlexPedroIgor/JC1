	...
	while (jogoRodando)
	{
		...
		if (SDL_PollEvent (&event))
		{
			...
			if (event.type == SDL_KEYDOWN)
			{
				...
				if (jogador_posicao.y < inimigo_posicao.y && jogador_posicao.x < inimigo_posicao.x)
				{
					inimigo_frame.x = 53;
					inimigo_posicao.y -= vely;
					inimigo_posicao.x -= velx;
				}
				else if (jogador_posicao.y < inimigo_posicao.y && jogador_posicao.x > inimigo_posicao.x)
				{
					inimigo_frame.x = 371;
					inimigo_posicao.y -= vely;
					inimigo_posicao.x += velx;
				...
				//Principais
				else if (jogador_posicao.y < inimigo_posicao.y )
				{
					inimigo_frame.x = 0;
					inimigo_posicao.y -= vely;
				}
				...
				else if (jogador_posicao.x < inimigo_posicao.x )
				{
					inimigo_frame.x = 106;
					inimigo_posicao.x -= velx;
				}
