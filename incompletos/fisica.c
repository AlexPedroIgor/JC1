...
int Atirar(Jogador *jogador, Tiro *tiro, numero)
{
	...
	Carrega_Tiro(int numero, &jogador);
	
	tiro->animacao == jogador->animacao;
	return tiro->animacao;
}
return 0;
}


//void renderiza_tiro(SDL_Renderer* renderer, SDL_Rect* frame, SDL_Rect* posicao, SDL_Texture* gTiro )
//{
//	SDL_RenderCopy(renderer, gTiro, &frame, &posicao);	
//}